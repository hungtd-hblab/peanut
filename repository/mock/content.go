...
func (m *MockContentRepo) CreateContent(cnt domain.Content) (*domain.Content, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateContent", cnt)
...
func (mr *MockContentRepoMockRecorder) CreateContent(cnt interface{}) *gomock.Call {
